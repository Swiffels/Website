...
function FeaturedProjects() {
  return (
    <div className="w-full bg-slate-100 text-center">
      ...
      <div className="flex justify-items-center items-center align-items-center justify-center flex-col lg:flex-row">
        <FeaturedProjectButton name={"Portfolio"} image={websiteProjectLogo} description={"Making a website"} />
        <FeaturedProjectButton name={"IoT Alarm Clock"} image={alarmClockLogo} description={"Webserver-based alarm clock"} />
