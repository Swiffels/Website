const FeaturedProjectButton = ({ name, image, description }) => {
  return (
    <div className="w-96 bg-steel_blue-600 bg-gradient-to-r from-steel_blue-700 h-[22rem] rounded-2xl transition-transform duration-300 ease-in-out transform hover:-translate-y-2 my-4 mx-6 overflow-hidden">
